...
for (const album of albums) {
  if (album.genre === 'Rock') {
    totalRock += album.duration
  }
}
console.log('El total de minutos de Rock son: ' + totalRock)
let horas = Math.floor(totalRock / 60)
let minutos = Math.round(totalRock % 60)
console.log(
  `La duración total de música Rock es: ${horas} horas y ${minutos} minutos.`
)
